...
function binarySearch(arr, x)
{
    ...
    logging.push({Action:"MESSAGE", Counter:counter++, message:`The array is ${arr.join()} the target is ${x}`});
    ...
    logging.push({Action:"RESULTS", Counter:counter++, message:`The index is -1 for target ${x}`});
    return -1;
}
